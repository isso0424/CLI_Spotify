...
func Choose(playlists []response.SearchResultItem) response.SearchResultItem {
...
func CheckDuplicateName(name string, playlistList []response.SearchResultItem) bool {
